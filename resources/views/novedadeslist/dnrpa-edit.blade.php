...
<!-- Modal Large-->
<div class="modal fade" id="myModalDNRPAEdit" name="myModalDNRPAEdit" tabindex="-2" role="dialog" aria-labelledby="myModalLabelLarge" aria-hidden="true">
  <div class="modal-dialog modal-lg">

    @if ($novedades != null)
        @if ($novedades->count() > 0)
            <form method="post" action="{{ url('/dnrpa/edit/'.$novedad->id) }}" enctype="multipart/form-data" name="dnrpa_ed_form" id="dnrpa_ed_form">
        @else
            <form method="post" action="{{ url('/dnrpa/edit/') }}" enctype="multipart/form-data" name="dnrpa_ed_form" id="dnrpa_ed_form">
        @endif
    @endif
    ...
    {{ csrf_field() }}
     ...
     <div class="modal-content">
        <div class="modal-header">
           <h4 class="modal-title" id="myModalLabelLargeS">Editar Formulario F.13 DNRPA  # </h4>
         ...
         <div class="col-md-12">
             <div class="form-row">
               <div class="col-lg-3 mb-3">
                  ...
                  <div class="input-group " name="legajo" id="legajo" data-provide="" keyboardNavigation="false">
                      ...
                      <input class="form-control" type="text" value="{{ $legajo->dominio }}" name="dnrpa_ed_dominio" id="dnrpa_ed_dominio"
               ...
               <div class="col-lg-3 mb-3">
                  ...
                  <input class="form-control" type="text" name="dnrpa_ed_interno" id="dnrpa_ed_interno"
                  disabled
               ...
               <div class="col-lg-6 mb-6">
                  ...
                  <input class="form-control" type="text" name="dnrpa_ed_deta" id="dnrpa_ed_deta"
                  disabled
          ...
          <div class="col-lg-12 mb-12">
                  ...
                  <div class="col-lg-3 mb-3">
                      <label class="col-form-label">Fecha de emisión * </label>
                          <div class="input-group date" id="datetimepicker1" data-provide="datepicker" data-date-format="dd/mm/yyyy"
                              ...
                              <input class="form-control" type="text" value="{{ old('fecha',$legajoNew->fecha) }}" name="dnrpa_ed_fecha" id="dnrpa_ed_fecha"
           ...
           <div class="col-lg-12 mb-12">
                ...
                name="dnrpa_ed_detalle" id="dnrpa_ed_detalle">{{ $legajoNew->detalle }}</textarea>
           </div>
        ...
        <div class="modal-footer">
           <div class="col-lg-9 mb-9">
              <button class="btn btn-warning" type="submit" name="btngrabarDNRPA" id="btngrabarDNRPA" style="height: 35.533px" value='borrar'>
