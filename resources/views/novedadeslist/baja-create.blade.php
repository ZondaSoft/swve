...
<!-- Modal Large-->
<div class="modal fade" id="myModalbaja" name="myModalbaja" tabindex="-2" role="dialog" aria-labelledby="multa-create" aria-hidden="true">
  <div class="modal-dialog modal-lg">

    <form method="post" action="{{ url('/baja_venta/add') }}" enctype="multipart/form-data">

     {{ csrf_field() }}

     <div class="modal-content">
        <div class="modal-header">
           <h4 class="modal-title" id="multa-create">Agregar venta o baja de vehículo </h4>
        ...
        <div class="modal-body">
         ...
         <div class="col-md-12">
              <div class="form-row">
                <div class="col-lg-3 mb-3">
                   ...
                   <div class="input-group " name="legajo" id="legajo" data-provide="" keyboardNavigation="false">
                       ...
                       <input class="form-control" type="text" value="{{ $legajo->dominio }}" name="ventas_dominio" id="ventas_dominio"
                ...
                <div class="col-lg-3 mb-3">
                   ...
                   <input class="form-control" type="number" name="ventas_interno" id="ventas_interno"
                   readonly
          ...
          <div class="col-md-12">
               <div class="form-row">
                   <div class="col-lg-5 mb-3">
                       ...
                       <select class="form-control" id="ventas_tipo" name="ventas_tipo" autocomplete='off'>
                         ...
                         <option value="Baja por transferencia de Destino" @if ($legajo->estado == 4)  selected   @endif  >Baja por transferencia de Destino</option>
                  ...
                  <div class="col-lg-3 mb-3">
                      <label class="col-form-label">Fecha * </label>
                          <div class="input-group date" id="datetimepicker1" data-provide="datepicker" data-date-format="dd/mm/yyyy"
                              ...
                              <input class="form-control" type="text" value="{{ old('fecha',$legajoNew->fecha) }}" name="ventas_fecha" id="ventas_fecha"
           ...
           <div class="col-lg-12 mb-12">
                ...
                name="ventas_detalle" id="ventas_detalle">{{ $legajoNew->detalle }}</textarea>
           </div>
          ...
          <div class="modal-footer">
             <button class="btn btn-danger" type="button" data-dismiss="modal" id="btncancelarBC"> Cancelar </button>
