...
<!-- Modal Large-->
<div class="modal fade" id="myModalCeta" name="myModalCeta" tabindex="-2" role="dialog" aria-labelledby="multa-create" aria-hidden="true">
  <div class="modal-dialog modal-lg">

    <form method="post" action="{{ url('/ceta/add') }}" enctype="multipart/form-data">

     {{ csrf_field() }}

     <div class="modal-content">
        <div class="modal-header">
           <h4 class="modal-title" id="multa-create">Agregar Formulario CETA</h4>
         ...
         <div class="col-md-12">
              <div class="form-row">
                <div class="col-lg-3 mb-3">
                   ...
                   <div class="input-group " name="legajo" id="legajo" data-provide="" keyboardNavigation="false">
                       ...
                       <input class="form-control" type="text" value="{{ $legajo->dominio }}" name="ceta_dominio" id="ceta_dominio"
                ...
                <div class="col-lg-3 mb-3">
                   ...
                   <input class="form-control" type="number" name="ceta_interno" id="ceta_interno"
                   readonly
                ...
                <div class="col-lg-6 mb-6">
                   ...
                   <input class="form-control" type="text" name="ceta_det_veh" id="ceta_det_veh"
                   disabled
          ...
          <div class="col-lg-12 mb-12">
                  ...
                  <div class="col-lg-3 mb-3">
                      <label class="col-form-label">Fecha de emisión * </label>
                          <div class="input-group date" id="datetimepicker1" data-provide="datepicker" data-date-format="dd/mm/yyyy"
                              ...
                              <input class="form-control" type="text" value="{{ old('fecha',$legajoNew->fecha) }}" name="ceta_fecha" id="ceta_fecha"
           ...
           <div class="col-lg-12 mb-12">
                ...
                name="ceta_detalle" id="ceta_detalle">{{ $legajoNew->detalle }}</textarea>
           </div>
          ...
          <div class="modal-footer">
             <button class="btn btn-danger" type="button" data-dismiss="modal" id="btncancelarCC"> Cancelar </button>
